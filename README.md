...
### 2.1 Registering Methods as Event Handlers
>[!WARNING]
...
### 2.2 Three Usage Variants for the [Event] Attribute
#### 2.2.1 Basic Event Registration by Name
```
[Event("EventName")]
...
#### 2.2.3Local Registration for a Specific Object
```
...
### 2.3 Publishing (Invoking) Events
...
```
## 3. Working with Data Requests
### 3.1 Data Request Mechanism
>[!WARNING]
